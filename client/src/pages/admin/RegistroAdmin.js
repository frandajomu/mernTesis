...
import useCreateInicialAdmin from '../../hooks/admin/useCreateInicialAdmin';
...
const RegistroAdmin = () => {
    ...
    const [UploadUserData] = useCreateInicialAdmin();
    ...
    useEffect(() => {
        register('role', { value: roles.admin })
    }, [register])

    return (
        <>
            <Helmet><title>Administrador Inicial</title></Helmet>
            <div className="container py-4">
                <div className="row">
                    <div className="col-11 col-md-7 mx-auto my-auto">
                        <h1 className="h2 mb-4 text-center text-primary" style={{ "fontWeight": "700" }}>Administrador Inicial</h1>
                        <div className="row">
                            ...
                            <form onSubmit={handleSubmit(onSubmit)}>
                                ...
                                {Next === 3 &&
                                    <>
                                        ...
                                        <div className="mb-3">
                                            <SelectorA className="flex-md-fill col-12 mt-2 mt-md-0" disabled>
