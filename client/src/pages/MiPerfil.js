            ...
            <div className='container-flex' style={{ "color": theme.moradoOscuro }}>
                <div className='row mt-5'>
                    <div className='col d-flex justify-content-center mb-5'>
                        <div className="card col-12 col-sm-8 col-lg-6" style={{ "borderColor": theme.moradoOscuro }} >
                            ...
                            <div className="card-body">
                                <h5 className="card-title text-center">{usuario?.name + ' ' + usuario?.lastname} </h5>
                                ...
                                <ul className="list-group list-group-flush">
                                    ...
                                    <li className="list-group-item">Grupo Sanguineo: {usuario?.blood}</li>
